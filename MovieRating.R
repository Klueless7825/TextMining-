...
setup_twitter_oauth(consumer_key = "drBAH5a9z3cXVPSE3rQLe18j2",
                    consumer_secret = "Ni0i7ITCq6kgXPCfOqETS4bBC1DPcCijX5ziHYC3ofFxq4OZqf", 
                    access_token = "4737221209-xypOI5eQR4cv29IKUMXMjaqSMn9NdYwBWcqskTQ",
                    access_secret = "puTYwux4lMtCgLdmAT1vphqLcIJBqQTaNqVe1s0DM5x1W")

#get the tweets
#Movie_name = "#TutakTutakTutiya"
tweets = searchTwitter("#TutakTutakTutiya", n=500, lang="en")
...
afinn_list <- read.delim(file='C:/Users/Santhosh/Documents/TextMining/AFINN.txt', header=FALSE, stringsAsFactors=FALSE)
...
barplot(mr[[1]], main="Movie Review", xlab="Number of votes",col=colors,ylim = c(0, 120))
#axis(2, at = 0:5, labels = 0:5)
legend("topright",mr[[2]],fill = colors, bty = "n",inset=c(-0.15, 0))
