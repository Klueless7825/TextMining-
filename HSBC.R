...
setwd("C:/Users/Santhosh/Documents/TextMining/")
...
save(corpora, file="C:/Users/Santhosh/Documents/TextMining/corpora.Rdat")
...
ToSentences = function(text, language="en") {
  ...
  markers = NLP::annotate(text,
    Maxent_Sent_Token_Annotator(language=language) )
...
corpus = Reduce(c, lapply(corpora1, CorpusToSentences))

corpora1 <- as.String(corpora)
word_ann <- Maxent_Word_Token_Annotator()
sent_ann <- Maxent_Sent_Token_Annotator()
## corpus[[1]]$content
corpus <- annotate(corpora1, list(sent_ann,word_ann))
...
lex = read.xlsx("C:/Users/Santhosh/Documents/TextMining/inquirerbasic.xls", stringsAsFactors=FALSE)
